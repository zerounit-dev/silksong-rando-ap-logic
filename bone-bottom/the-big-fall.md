...
| MR | middle right | middle right ledge | [mosshome upper](./mosshome-upper.md) -L | breakable wall -must be opened from the other side (NEEDS VERIFICATION) |
| LR | lower right | lower right area | [mosshome lower](./mosshome-lower.md) -L | none |
| UL | upper left | upper left ledge | TODO | none |
| LL | lower left | lower left area | wormways entrance -R | none |
| LF | left floor | bottom area | [bone bottom](./bone-bottom.md) -LC | none |
| RF | right floor | lower right area | [bone bottom](./bone-bottom.md) -RC | none |
